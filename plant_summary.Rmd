...
```{r denden}
knitr::include_graphics("output/denden.png")
```
...
Two major pollinators are *Andrena erigeniae*, which specializes on pollen and is closely associated with this genus, and a bee-fly *Bombylius major* [@parker2018].
...
### Ecology
Beech nuts are important sources of food for a variety of mammals and once were a primary food of the passenger pigeon [@conrad2005]. It is also used as timber and as firewood or in smoking meats and cheeses.
